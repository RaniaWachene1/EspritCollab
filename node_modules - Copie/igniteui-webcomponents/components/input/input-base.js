...
let IgcInputBaseComponent = IgcInputBaseComponent_1 = class IgcInputBaseComponent extends FormAssociatedRequiredMixin(SizableMixin(EventEmitterMixin(LitElement))) {
    set readonly(value) {
        this.readOnly = value;
    }
    get readonly() {
...
], IgcInputBaseComponent.prototype, "readonly", null);
__decorate([
    property()
