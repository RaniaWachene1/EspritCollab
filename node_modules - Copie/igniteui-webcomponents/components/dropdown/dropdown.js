...
let IgcDropdownComponent = class IgcDropdownComponent extends SizableMixin(EventEmitterMixin(IgcBaseComboBoxLikeComponent)) {
    static register() {
        registerComponent(this, IgcDropdownGroupComponent, IgcDropdownHeaderComponent, IgcDropdownItemComponent, IgcPopoverComponent);
    }
    get _activeItems() {
